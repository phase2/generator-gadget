 ...
 */
function <%= nameFunc %>_apps_servers_info() {
 ...
 */
function <%= nameFunc %>_form_install_configure_form_alter(&$form, &$form_state) {
 ...
 */
function <%= nameFunc %>_form_panopoly_theme_selection_form_alter(&$form, &$form_state, $form_id) {
